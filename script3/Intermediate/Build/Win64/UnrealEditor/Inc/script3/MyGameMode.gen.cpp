...
#include "script3/MyGameMode.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMyGameMode() {}
// Cross Module References
	SCRIPT3_API UClass* Z_Construct_UClass_AMyGameMode_NoRegister();
	SCRIPT3_API UClass* Z_Construct_UClass_AMyGameMode();
...
// End Cross Module References
	...
	template<> SCRIPT3_API UClass* StaticClass<AMyGameMode>()
	{
		return AMyGameMode::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AMyGameMode);
	struct Z_CompiledInDeferFile_FID_script3_Source_script3_MyGameMode_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_script3_Source_script3_MyGameMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMyGameMode, AMyGameMode::StaticClass, TEXT("AMyGameMode"), &Z_Registration_Info_UClass_AMyGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMyGameMode), 2893830807U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_script3_Source_script3_MyGameMode_h_3394060269(TEXT("/Script/script3"),
		Z_CompiledInDeferFile_FID_script3_Source_script3_MyGameMode_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_script3_Source_script3_MyGameMode_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
